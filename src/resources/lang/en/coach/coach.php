...
return[
    ...
    "lesson" => [
        ...
        "postNote" => "Post note",
        "lesson.create" => "The lesson has been created by :created_by_name:",
        "lesson.add_coach" => ":created_by_name: has added coach :coach_name: to the lesson.",
        "lesson.remove_coach" => ":created_by_name: has removed coach :coach_name: from the lesson.",
        "lesson.add_player" => ":created_by_name: has added player :player_name: to the lesson.",
        "lesson.remove_player" => ":created_by_name: has removed player :player_name: from the lesson.",
        "lesson.start" => ":created_by_name: has started the lesson.",
        "lesson.end" => ":created_by_name: has ended the lesson.",
        "lesson.cancel" => ":created_by_name: has canceled the lesson.",
        "lesson.player.attend" => ":created_by_name: has marked the player :player_name: as attend.",
        "lesson.player.absent" => ":created_by_name: has marked the player :player_name: as absent.",
        "lesson.player.endLesson" => "The lesson has been ended for the player :player_name: by :created_by_name:.",
        "lesson.coach.attend" => ":created_by_name: has marked the coach :coach_name: as attend.",
        "lesson.coach.absent" => ":created_by_name: has marked the coach :coach_name: as absent.",
        "lesson.coach.endLesson" => "The lesson has been ended for the coach :coach_name: by :created_by_name:.",
    ],
    "coaches" => [
